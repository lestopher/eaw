class DashboardController < ApplicationController
  ...
  def index 
    ...
    @flash = 'Could not find session id' and exit unless reponse.data.SessionId
    ...
    @url = "#{endpoint}:#{port}/Argos/AWV/#!DataBlock=#{datablock}&Username=#{username}&Token=#{token}&Hash=#{hash}"     
  end
